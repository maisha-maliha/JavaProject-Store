...
public class AdminFoodController {
	...
	@FXML
	public TextField pname = new TextField("heelo");
	
	@FXML
	public TextField expd;
	
	@FXML
	public TextField price;
	
	@FXML
	public TextField mfd;
	...
	//============ ALL ACTIONS ==============
	public String filepath = "src/application/FoodIteamName.txt";
	public String filepath2 = "src/application/FoodIteamName2.txt";
